let audios = ['sounds_boom.wav','sounds_clap.wav','sounds_hihat.wav','sounds_kick.wav','sounds_openhat.wav','sounds_ride.wav','sounds_snare.wav','sounds_tink.wav','sounds_tom.wav']
